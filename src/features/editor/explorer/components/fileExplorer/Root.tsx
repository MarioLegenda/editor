      ...
      <div css={styles.content}>
        ...
        <div>
          <Button
            ...
            color="gray"
            variant="subtle">
            <IconArrowBackUp color="gray" size={24} />
          </Button>
          ...
          <Menu>
            ...
            <Menu.Dropdown>
              <Menu.Item
                onClick={() => setCreateFileModalData('default')}
                css={styles.menuItem}
                icon={<AnyFileIcon />}>
                File
              </Menu.Item>
              <Menu.Item
                onClick={() => setCreateFileModalData('typescript')}
                css={styles.menuItem}
                icon={<TypescriptIcon />}>
                Typescript
              </Menu.Item>
              <Menu.Item
                onClick={() => setCreateFileModalData('javascript')}
                css={styles.menuItem}
                icon={<JavascriptIcon />}>
                Javascript
              </Menu.Item>
              <Menu.Item
                onClick={() => setCreateFileModalData('yaml')}
                css={styles.menuItem}
                icon={<YamlIcon />}>
                YAML
              </Menu.Item>
              <Menu.Item
                onClick={() => setCreateFileModalData('json')}
                css={styles.menuItem}
                icon={<JsonIcon />}>
                JSON
              </Menu.Item>
